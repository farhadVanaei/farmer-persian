...
class Farmer(Model):
    ...
    phone = Column(String(450,collation='utf8_bin'))
    fathername = Column(String(450,collation='utf8_bin'))
    NationalNumber = Column(String(450,collation='utf8_bin'))
    email = Column(String(450,collation='utf8_bin'))
